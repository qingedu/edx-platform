...
def parse_args():
    ...
    lms.add_argument('-h', '--help', action='store_true', help='show this help method and exit')
    lms.add_argument(
        '-e', '--environment',
    ...
    cms.add_argument(
        ...
        default='dev',
        help='Which environment settings module to use')
    cms.add_argument('-h', '--help', action='store_true', help='show this help method and exit')
